...
It became clear to me I should first focus on making OSv boot on Firecracker without block and networ devices. Luckily OSv can be built with RamFS where application code is placed in **bootfs** part of loader.elf. 
